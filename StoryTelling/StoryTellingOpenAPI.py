...
openai.api_key = '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'
...
result_text = tk.Text(app, width=50, height=10, wrap=tk.WORD, yscrollcommand=scrollbar.set)
